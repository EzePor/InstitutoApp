...
namespace InstitutoApp.Services
{
    public class GenericService<T> : IGenericService<T> where T : class
    {
        ...
        // incorporamos la UrlApi en propiedades y borramos appsettings, luego correjimos Properties.Resources.UrlApi ... así tenemos mayor seguridad con la url y no quede en el código
